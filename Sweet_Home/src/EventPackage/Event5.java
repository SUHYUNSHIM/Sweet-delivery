...
public class Event5 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event5 frame = new Event5("아이디","이름","비밀번호","폰번호","주소");
	...
	public Event5(String id, String name, String pw, String phone, String address) {
		...
		label.setIcon(new ImageIcon(Event5.class.getResource("/image2/\uC5B4\uD50C\uBB38\uAD6C.png")));
		...
		label_6.setIcon(new ImageIcon(Event5.class.getResource("/image2/06_냥바타콘_100x100_09_침.png")));
		label_6.setBounds(666, 312, 117, 128);
		contentPane.add(label_6);
		
		JLabel label_10 = new JLabel("");
		label_10.setIcon(new ImageIcon(Event5.class.getResource("/image2/04_모코코콘2_ㄹㅇ.gif")));
		label_10.setBounds(850, 38, 117, 91);
		contentPane.add(label_10);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(Event5.class.getResource("/image2/restaurant.png")));
