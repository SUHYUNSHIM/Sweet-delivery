...
public class Event122 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event122 frame = new Event122("아이디","이름","비밀번호","폰번호","주소");
	...
	public Event122() {}
	public Event122(String id, String name, String pw, String phone, String address) { //생성자. 
		...
		btn1.setIcon(new ImageIcon(Event122.class.getResource("/image2/\uBB34\uCF54\uCF541.jpg")));
		...
		btn2.setIcon(new ImageIcon(Event122.class.getResource("/image2/\uBB34\uCF54\uCF541.jpg")));
		...
		btn3.setIcon(new ImageIcon(Event122.class.getResource("/image2/\uBB34\uCF54\uCF541.jpg")));
		...
		btn6.setIcon(new ImageIcon(Event122.class.getResource("/image2/\uBB34\uCF54\uCF541.jpg")));
		...
		btn4.setIcon(new ImageIcon(Event122.class.getResource("/image2/\uBB34\uCF54\uCF541.jpg")));
		...
		btn5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane aa = new JOptionPane();
				   ...
				   rw.WriteToFile(0.10, "Event Reward");
			}
		});
		btn5.setIcon(new ImageIcon(Event122.class.getResource("/image2/\uBB34\uCF54\uCF541.jpg")));
		...
		btn8.setIcon(new ImageIcon(Event122.class.getResource("/image2/\uBB34\uCF54\uCF541.jpg")));
		...
		btn7.setIcon(new ImageIcon(Event122.class.getResource("/image2/\uBB34\uCF54\uCF541.jpg")));
		...
		btn9.setIcon(new ImageIcon(Event122.class.getResource("/image2/\uBB34\uCF54\uCF541.jpg")));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				setVisible(false);
				new Event4(id,name,pw,phone,address).setVisible(true);
			}
		});
