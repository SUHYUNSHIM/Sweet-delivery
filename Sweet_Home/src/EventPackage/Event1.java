...
public class Event1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event1 frame = new Event1("아이디","이름","비밀번호","폰번호","주소");
	...
	public Event1(String id, String name, String pw, String phone, String address) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				setVisible(false);
				new Event3(id,name,pw,phone,address).setVisible(true); //창립 기념 5000P획득 화면으로 전환.
			}
		});
		...
		btnGoback.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					new MainPage(id,name,pw,phone,address).setVisible(true); //메인페이지로 돌아간다.
		...
		contentPane.add(lblDeliverysweetnavercom);
		...
		textArea.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				dispose();
				setVisible(false);
				new Event3(id,name,pw,phone,address).setVisible(true);
			}
		});
