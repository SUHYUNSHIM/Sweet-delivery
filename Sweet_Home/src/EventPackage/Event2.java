...
public class Event2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event2 frame = new Event2("아이디","이름","비밀번호","폰번호","주소");
	...
	public Event2() {}
	public Event2(String id, String name, String pw, String phone, String address) {
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				dispose();
				setVisible(false);
				new Event5(id,name,pw,phone,address).setVisible(true);
			}
		});
		...
		button_5.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				dispose();
				setVisible(false);
				new Event1(id,name,pw,phone,address).setVisible(true); //Event1이 4가지의 생성자 값을 받아야 하는 이유는, mainPage로 돌아갈 때 4개의 값인 id, name,pw,phone,
