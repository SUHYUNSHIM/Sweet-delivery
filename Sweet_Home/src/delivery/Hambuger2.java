...
public class Hambuger2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Hambuger2 frame = new Hambuger2(0, "0", "0","아이디");
	...
	public Hambuger2(int defaultPrice, String option, String total,String id) {
		...
		button.setBounds(400, 48, 117, 29);
		contentPane.add(button);
		
		JLabel chicken1 = new JLabel("불고기 버거");
		chicken1.setIcon(new ImageIcon(Hambuger2.class.getResource("/image3/hambuger2.jpg")));
		chicken1.setBounds(64, 104, 150, 130);
		...
		button_2.setBounds(37, 312, 117, 29);
		contentPane.add(button_2);
		
		JLabel lblNewLabel_1 = new JLabel("불고기 버거");
		lblNewLabel_1.setFont(new Font("Lucida Grande", Font.BOLD, 15));
		lblNewLabel_1.setBounds(233, 108, 98, 29);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("6000");
		...
		JCheckBox Box2 = new JCheckBox("치킨너겟 4조각 +1500");
