...
public class SchoolFood1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SchoolFood1 frame = new SchoolFood1(0, "0", "0","아이디");
	...
	public SchoolFood1(int defaultPrice, String option, String total,String id) {
		...
		JLabel chicken1 = new JLabel("떡볶이");
		chicken1.setIcon(new ImageIcon(SchoolFood1.class.getResource("/image3/schoolfood1.jpg")));
		...
		button_2.setBounds(25, 312, 117, 29);
		contentPane.add(button_2);
		
		JLabel lblNewLabel_1 = new JLabel("떡볶이");
