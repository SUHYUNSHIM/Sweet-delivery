...
public class ChineseFood3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChineseFood3 frame = new ChineseFood3(0, "0", "0","아이디");
	...
	public ChineseFood3(int defaultPrice, String option, String total,String id) {
		...
		button.setBounds(400, 56, 117, 29);
		contentPane.add(button);
		
		JLabel chicken1 = new JLabel("탕수육");
		chicken1.setIcon(new ImageIcon(ChineseFood3.class.getResource("/image3/chinese3.jpg")));
		chicken1.setBounds(72, 108, 150, 150);
		...
		JLabel lblNewLabel_1 = new JLabel("탕수육");
		...
		JCheckBox Box1 = new JCheckBox("소 +0");
		...
		JCheckBox Box2 = new JCheckBox("중 +2000");
		...
		JCheckBox Box3 = new JCheckBox("대 +4000");
