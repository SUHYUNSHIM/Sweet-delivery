...
public class ChineseFood1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChineseFood1 frame = new ChineseFood1(0, "0", "0","아이디");
	...
	public ChineseFood1(int defaultPrice, String option, String total,String id) {
		...
		button.setBounds(400, 54, 117, 29);
		contentPane.add(button);
		
		JLabel chicken1 = new JLabel("짜장면");
		chicken1.setBackground(Color.WHITE);
		chicken1.setIcon(new ImageIcon(ChineseFood1.class.getResource("/image3/chinese1.jpg")));
		chicken1.setBounds(65, 107, 150, 150);
		...
		JLabel lblNewLabel_1 = new JLabel("짜장면");
		lblNewLabel_1.setFont(new Font("Lucida Grande", Font.BOLD, 15));
		lblNewLabel_1.setBounds(233, 108, 98, 29);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("4000");
