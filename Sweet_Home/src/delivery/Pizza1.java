...
public class Pizza1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Pizza1 frame = new Pizza1(0, "0", "0","아이디");
	...
	public Pizza1(int defaultPrice, String option, String total,String id ){
		...
		JLabel chicken1 = new JLabel("치즈 피자");
		chicken1.setIcon(new ImageIcon(Pizza1.class.getResource("/image3/pizza1.jpg")));
		chicken1.setBackground(Color.WHITE);
		chicken1.setBounds(62, 107, 150, 150);
		...
		button_2.setBounds(30, 312, 117, 29);
		contentPane.add(button_2);
		
		JLabel lblNewLabel_1 = new JLabel("치즈 피자");
