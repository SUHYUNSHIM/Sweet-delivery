...
public class Hambuger3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Hambuger3 frame = new Hambuger3(0, "0", "0","아이디");
	...
	public Hambuger3(int defaultPrice, String option, String total,String id) {
		...
		button.setBounds(387, 52, 117, 29);
		contentPane.add(button);
		
		JLabel chicken1 = new JLabel("치즈 버거");
		chicken1.setIcon(new ImageIcon(Hambuger3.class.getResource("/image3/hambuger3-2.png")));
		chicken1.setBounds(63, 105, 150, 150);
		...
		button_2.setBounds(39, 312, 117, 29);
		contentPane.add(button_2);
		
		JLabel lblNewLabel_1 = new JLabel("치즈 버거");
